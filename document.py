...
from image_colorizer.base import validate_requirement, suppress
...
def generate_md(
        package: str, destination: Optional[str] = None,
...
def generate_html(
        package: str, destination: Optional[str] = None,
        reload: Optional[bool] = False, show: Optional[bool] = True
) -> None:
    """
    Generates the documentation for the package.
...
def main(
        location: str, destination: Optional[str] = "docs",
        reload: Optional[bool] = True, show: Optional[bool] = False
) -> None:
    """
...
if __name__ == "__main__":
    main(location="image_colorizer", reload=True, show=True)
# end if